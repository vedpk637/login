...
export class AppComponent implements OnInit{
  ...
  ngOnInit() {
    this.myReactiveForm = new FormGroup({
      'fName': new FormControl(null,[Validators.required,Validators.pattern('^[a-zA-Z ]*$')]), // validators for user name
  ...
  // to submit page data
  submitForm(uname1,uname2){
     alert("Welcome ! "+ uname1.value+" "+uname2.value)
  }
